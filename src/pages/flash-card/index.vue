...
import MCreateFolder from '@/components/flash-card/folder/MCreateFolder.vue'
  ...
  <div class="w-full p-8 flex flex-col gap-6 overflow-hidden h-full">
    ...
    <div class="flex justify-between items-center">
      ...
      <div class="flex items-center gap-10">
        <h2 class="text-2xl font-semibold whitespace-nowrap">Your FlashCard</h2>
      ...
      <Button @click="openModal">
        <span class="i-material-symbols-light-add text-2xl h-10"></span>
        Create
      </Button>
    </div>
    ...
    <div class="flex-auto overflow-y-auto">
      ...
      >
        <img
          ...
          alt=""
        />
        <p>No FlashCard found. Create one now!</p>
      </div>
      <QuizzflyList v-else />
    </div>
    <div
